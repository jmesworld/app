...
export default function BackUpScreen({ navigation, route }: Props) {
  ...
  const signature = wallet.signMessage('jmesworld')
  const address = account.getAddress()
  const privateKey = account.derivableAccountKey.privateKey // this creates the master key which other privatekeys can be derivefrom
  //const masterKey = wallet.chainDerivedKey.privateKey // masterkey may need to use this function instead of masterkey
